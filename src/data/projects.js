...
// Artist artwork paths
export const artistArtworks = [
  { path: 'assets/priyanka-bardhan-artworks', count: 5 }, // 0 - Priyanka Bardhan
  { path: 'assets/madhushree-pawar-artworks', count: 5 }, // 1 - Madhushree Pawar
  { path: 'assets/vivek-kisan-vadkar-artworks', count: 3 }, // 2 - Vivek Kisan Vadkar
  { path: 'assets/panchu-gharami-artworks', count: 5 }, // 3 - Panchu Gharami
  { path: 'assets/sangita-agarwal-artworks', count: 5 }, // 4 - Sangita Agarwal
  { path: 'assets/sanjana-patel-artworks', count: 5 }, // 5 - Sanjana Patel
  { path: 'assets/richard-anbudurai-artworks', count: 3 }, // 6 - Richard Anbudurai
];
